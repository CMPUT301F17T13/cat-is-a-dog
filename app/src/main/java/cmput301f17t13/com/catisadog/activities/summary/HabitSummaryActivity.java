...
/**
 * The activity that handles three tabs: my habitEvents, to do habitEvents, and
 * following habitEvents.
...
public class HabitSummaryActivity extends BaseDrawerActivity {
    ...
    /**
     * Navigate to the Add/Edit Habit Activity when the user clicks the floating
     * plus icon
